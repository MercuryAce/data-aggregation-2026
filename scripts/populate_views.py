...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Populate MySQL view tables (CG structure + optional CMC metrics)."
    )
    parser.add_argument(
        "--tables",
    ...
    if not args.tables and not args.patch_cmc:
        parser.error("Provide --tables and/or --patch-cmc")
